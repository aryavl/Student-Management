  ...
  return (
    ...
    <div className="flex flex-col justify-center  items-center ">
        ...
        <div className='mt-5 flex flex-col justify-center item-center'>
            <h1 className='bg-green-900 text-white rounded-lg px-10 py-2 text-center mb-3 '>Name: {session?.user?.teacherName}</h1>
            <h1 className='bg-green-900 text-white rounded-lg px-10 py-2 text-center mb-3 '>Email: {session?.user?.email}</h1>
            <h1 className='bg-green-900 text-white rounded-lg px-10 py-2 text-center mb-3 '>Stream: {session?.user?.stream}</h1>
            <h1 className='bg-green-900 text-white rounded-lg px-10 py-2 text-center mb-3 '>Subject: {session?.user?.subject}</h1>
        </div>
