...
const CommerceBatchContent = () => {
   
    const { data, error } = useSWR('http://localhost:3000/api/commerceDivisionPlusOne', async (url) => {
  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center  sm:px-20 md:px-28 py-4  ">
        ...
        <h3 className="text-center font-bold   text-lg">Commerce Department</h3>
...
export default CommerceBatchContent
